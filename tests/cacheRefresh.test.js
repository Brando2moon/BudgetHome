...
test('publishes a one-click cache reset page for release 10', async () => {
  ...
  assert.match(refresh, /location\.replace\(['"]\.\/\?release=10['"]\)/);
});
